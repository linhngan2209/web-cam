(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_9b13e5._.js", {
...
;
;
const PasswordInput = ({ password, setPassword, passwordVisible, togglePasswordVisibility })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "relative",
        children: [
...
const Login = ()=>{
    ...
    const { login } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthenticationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const togglePasswordVisibility = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Login.useCallback[togglePasswordVisibility]": ()=>{
            setPasswordVisible({
                "Login.useCallback[togglePasswordVisibility]": (prev)=>!prev
            }["Login.useCallback[togglePasswordVisibility]"]);
        }
    }["Login.useCallback[togglePasswordVisibility]"], []);
    const handleLogin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Login.useCallback[handleLogin]": async (e)=>{
            e.preventDefault();
            if (!isFormValid) {
            ...
            try {
                ...
                if (loginError) {
                    ...
                    const hardwaresResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/api/user/get-user-hardware', {
                        params: {
                            limit: 10,
                            page: 1
                        },
                    ...
                    const hardwares = hardwaresResponse.data.data;
                    // Kiểm tra xem có hardware nào không
                    if (hardwares && hardwares.length > 0) {
                        // Lấy ID của hardware đầu tiên (hoặc hardware được chọn)
                        const hardwareId = hardwares[0].id;
                        // Chuyển hướng đến trang /authenticated/dashboard/[id]
                        router.replace(`/authenticated/dashboard/${hardwareId}`);
                    }
                }
            } catch (err) {
...
_s(Login, "MpbHLn76VkRhtZPba2mavtxmdyM=", false, function() {
    return [
...
var _c, _c1;
__turbopack_refresh__.register(_c, "PasswordInput");
...
//# sourceMappingURL=src_9b13e5._.js.map