(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_fef485._.js", {
...
const Sidebar = ()=>{
    ...
    const { data: hardwares = [], isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'user-hardwares'
        ],
        queryFn: {
...
_s(Sidebar, "7fTG4PUANHbRMI2y795chxO/bHA=", false, function() {
    return [
...
_s(RootLayout, "JFIO1L7CSejYJcuYdRAdZ8cVedo=", true, function() {
    return [
...
//# sourceMappingURL=src_fef485._.js.map